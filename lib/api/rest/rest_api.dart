...
class EnterRestApi {
  ...
  void _mapDioError(DioException e) {
  ...
  Future<Response> post(
    ...
    try {
      return await dio.post(_baseUrl + path,
          data: data,
          options: options,
...
class ApiError implements Exception {
  ...
  ApiError({this.exception, this.data});
  ...
  String toString() {
    ...
    return 'ApiError{exception: $exception}';
  }
}

class ApiErrorBadRequest extends ApiError {
  ApiErrorBadRequest(
      {Map<String, dynamic> data = const {'message': 'Bad Request'}})
      : super(data: data);
}

class ApiErrorUnauthorized extends ApiError {
  ApiErrorUnauthorized(
      {Map<String, dynamic> data = const {'message': 'Unauthorized'}})
      : super(data: data);
}

class ApiErrorForbidden extends ApiError {
  ApiErrorForbidden(
      {Map<String, dynamic> data = const {'message': 'Forbidden'}})
      : super(data: data);
}

class ApiErrorInternalServer extends ApiError {
  ApiErrorInternalServer(
      {Map<String, dynamic> data = const {'message': 'Internal Server Error'}})
      : super(data: data);
}
